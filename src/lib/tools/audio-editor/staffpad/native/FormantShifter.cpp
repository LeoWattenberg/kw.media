...
/* Modified 2026-07-13 for kw.media: removed desktop file logging and preferences. */
/*!********************************************************************
...
#include "utility/MapToPositiveHalfIndex.h"
#include "utility/MathApprox.h"
#include <algorithm>
#include <cassert>
...
FormantShifter::FormantShifter(int sampleRate, double cutoffQuefrency)

...
export const sitePages: SitePage[] = [
	...
	},
	{
		...
		blocks: [
			...
			{ type: 'posts', title: 'YouTube Tips & Tricks', categoryId: 18, limit: 3, moreHref: '/category/youtube-tips-en/', moreLabel: 'More tips' },
	...
	},
	{
		...
		blocks: [
			...
			{ type: 'posts', title: 'YouTube Tipps & Tricks', categoryId: 17, limit: 3, moreHref: '/category/youtube-tipps-de/', moreLabel: 'Mehr Tipps' },
			creatorPricingDe,
			martinDe,
			contactDe,
		],
	...
	},
	{
		...
		blocks: [
			...
			aboutEn,
			{
				...
				note: 'Excluding VAT.',
				items: [
					{ name: 'Free resources', summary: 'Updates and guides', price: 'Free', features: ['YouTube updates on our channel', 'Creator guides'], action: { label: 'Read tips', href: '/category/youtube-tips-en/' } },

---
id: 3139
slug: "title-a-b-testing-on-youtube-and-playlist-voting"
path: "/youtube-tips-en/title-a-b-testing-on-youtube-and-playlist-voting/"
title: "Title A/B Testing on YouTube & Playlist Voting"
excerpt: "YouTube Updates: This week, we start with a new playlist feature called Playlist Voting . It's turned off by default, and creators can enable it only in the YouTube main app (not on desktop or in YouTube Studio)."
...
postCta:
  text: "Confused about these new YouTube features? Our {page} team can help. We offer expert consulting to maximize your channel's potential."
  pagePath: "/en/creator/"
...
This new feature allows you to enter up to three variations of a title, three thumbnails (as with the existing [thumbnail A/B testing](/youtube-tips-en/the-secret-formula-of-a-b-tests-on-youtube/)), or a combination of three titles and three thumbnails. This raises interesting questions about autodubbing and auto-translations for titles and descriptions. Since titles are limited to around 100 characters, translating multiple variations shouldn't be too challenging.

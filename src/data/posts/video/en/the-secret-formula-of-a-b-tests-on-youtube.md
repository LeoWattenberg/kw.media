---
id: 3027
slug: "the-secret-formula-of-a-b-tests-on-youtube"
path: "/youtube-tips-en/the-secret-formula-of-a-b-tests-on-youtube/"
title: "The Secret Formula of A/B Tests on YouTube"
excerpt: "Explains how YouTube A/B tests use statistical confidence, sample size, and thumbnail performance gaps to decide whether a test has a winner."
...
Many Creators spend hours meticulously crafting multiple thumbnail options, only to run an [A/B test](/youtube-tips-en/what-is-youtube-test-and-compare-or-thumbnail-a-b-testing/) and receive a frustrating result two weeks later: "no winner." When this happens, it is easy to assume that the system is based on a fixed number of impressions or a specific amount of watch time. However, the process is far more complex.
...
While it may seem beneficial to test as many options as possible, small and mid-sized Creators should be cautious when utilizing [three-thumbnail tests](/youtube-tips-en/how-to-use-youtubes-new-thumbnail-test-and-compare-feature-for-better-engagement/). 
...
A common misconception is that the winner of an [A/B test](/youtube-tips-en/a-b-testing-on-youtube-everything-you-need-to-know-for-the-summer-launch/) is decided solely by the [Click-Through Rate (CTR)](/en/creator/). In reality, YouTube determines the winner based on **watch time per impression**. 

This metric is not a "black box"; it is essentially the product of two factors:
**Click-Through Rate × Average View Duration = Watch Time per Impression.**
...
This is the secret formula for [YouTube A/B testing](/youtube-tips-en/what-is-youtube-test-and-compare-or-thumbnail-a-b-testing/). You can spend hours crafting the perfect thumbnails, run an A/B test, and two weeks later YouTube gives you the worst possible result: no winner. You might think the feature is based on a fixed number of impressions or a fixed amount of watch time, but it is not. YouTube uses a statistical cutoff point, and that equation decides when your test ends.
...
That is why small and mid-sized creators should be careful with [three-thumbnail tests](/youtube-tips-en/how-to-use-youtubes-new-thumbnail-test-and-compare-feature-for-better-engagement/). An A/B/C test divides limited traffic across three variants and also adds a stricter statistical requirement, because YouTube has to compare every thumbnail against the others. If your video does not naturally receive a lot of traffic, testing three variants can make a clear result much less likely.

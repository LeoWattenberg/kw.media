...
Eine Funktion, die viele Creator schon lange vermisst haben, findet nun ihren Weg in die mobile App. Bisher war es nur über das [YouTube Studio](/de/creator/) am Desktop möglich, eine Liste der eigenen Abonnenten einzusehen. Seit dieser Woche wird diese Funktion schrittweise in der YouTube-App integriert.
...
Neben der Abonnentenliste gibt es eine kleine, aber effektive Verbesserung im [YouTube Studio Mobile](/youtube-tipps-de/alles-neu-im-youtube-studio-mobile-inhalts-und-community-tab-updates/). Hier wurde der Header im Bereich Analytics angepasst.
...
Für alle, die regelmäßig [live streamen](/de/live/), gibt es gute Nachrichten: Die sogenannte „Take a Break“-Funktion (Pause machen) wurde nun vollständig ausgerollt. Diese Funktion erlaubt es dir, während eines Live-Streams eine kurze Auszeit zu nehmen, ohne den Stream beenden oder improvisieren zu müssen.
...
Um auf dem Laufenden zu bleiben, lohnt es sich, regelmäßig die neuesten [YouTube-Updates](/youtube-tipps-de/youtube-updates-youtube-studio-app-youtube-app-kommentare-community-posts/) zu verfolgen und die eigenen Analytics genau im Auge zu behalten.
<!-- kwm:article:end -->

---
id: 3406
slug: "ich-habe-an-audacity-4-gearbeitet-das-musst-du-wissen"
path: "/audacity/ich-habe-an-audacity-4-gearbeitet-das-musst-du-wissen/"
title: "Ich habe an Audacity 4 gearbeitet: Das musst du wissen"
excerpt: "Leo Wattenberg führt durch Audacity 4 Beta 1 und zeigt die wichtigsten Änderungen bei Design, Bearbeitung, Effekten und Projekten."
...
Wir haben eine neue und farbenfrohe Logik hinzugefugt, die jede Spur unterschiedlich einfarbt. Wenn du aber den Stil von [Audacity 3](/audacity/ffmpeg-fur-audacity-installieren-tutorial/) bevorzugst, steht dir auch dieser weiterhin zur Verfugung. Du wirst merken, dass das in diesem Video ein kleines wiederkehrendes Thema sein wird: Einer unserer Leitgedanken war, Audacity naturlich modern zu halten, aber zugleich vertraut fur alle, die viele, viele Jahre an [Audacity 3](/audacity/ffmpeg-fur-audacity-installieren-schnelltutorial/) gewohnt waren. Deshalb gibt es auch verschiedene Optionen dafur, was du in deiner Werkzeugleiste haben mochtest.
...
Das ist die Art von Sache, die am Anfang einer Tour vielleicht ein bisschen banal aussieht, aber hoffentlich genau das ist, was [Bearbeitung in Audacity 4](/de/tools/audio/) im Vergleich zu Audacity 3 deutlich einfacher machen wird. Wir haben ausserdem einen neuen Modus hinzugefugt: das Split-Werkzeug. Beim Split-Werkzeug wahlst du es aus und klickst dann in deinen Clip, um ihn zu schneiden. So einfach ist das.

...
For copyrighted works, there also are exceptions to the “you must ask for permission” rule, most famously [fair use](/en/youtube-tips/). There’s a lot of myths regarding this one and they all seem to make it this magical solution to all your problems. Which it isn’t. **Fair use is very strict and narrow in scope**. You can’t just write “no copyright intended” or “this video is fair use” in your description. That doesn’t help you at all. Fair use is defined by [four factors](https://fairuse.stanford.edu/overview/fair-use/four-factors/), which a judge will try to apply to your content if you use something someone else made.

---
id: 1428
slug: "the-fuck-copyright-guide-how-to-legally-use-things-in-your-videos-that-other-people-made"
path: "/youtube-tips-en/the-fuck-copyright-guide-how-to-legally-use-things-in-your-videos-that-other-people-made/"
title: "The “Fuck Copyright” guide: How to legally use things in your videos that other people made"
excerpt: "A plain-language copyright guide for creators who want to use music, clips and other people's work without risking their channel."
...
There are a few exceptions to this. For one, not *everything* actually is copyrighted anymore. Copyright eventually expires, typically 70 years after the author (=the person who made the thing) died. So as of 2020, you can use works if the author of the work died in 1949 or earlier, usually. For comparison, the Lumiére brothers (who can be regarded as the inventors of cinema and by extension, the entire medium of motion pictures/movies) only died in 1948 and 1954, respectively. Some countries have longer protection terms than that, some have shorter ones, and the USA especially [has an unholy mess of 60 different conditions](https://copyright.cornell.edu/publicdomain). For example, works made by the US government are never copyrighted.
...
For copyrighted works, there also are exceptions to the “you must ask for permission” rule, most famously [fair use](/en/youtube-tips/). There’s a lot of myths regarding this one and they all seem to make it this magical solution to all your problems. Which it isn’t. **[Fair use](/en/creator/) is very strict and narrow in scope**. You can’t just write “no copyright intended” or “this video is fair use” in your description. That doesn’t help you at all. Fair use is defined by [four factors](https://fairuse.stanford.edu/overview/fair-use/four-factors/), which a judge will try to apply to your content if you use something someone else made.
...
Overall, **don’t fuck with copyright, or it will fuck you**. There is a copyright case in Germany (“[metal on metal](https://legal-patent.com/international-intellectual-property/music-sampling-metal-on-metal-goes-back-to-the-olg/)“) about a song which used just *TWO SECONDS* of a different song, which has been going on since 1999. It has been going all the way up to the European Court of Justice, the German Federal Constitutional Court, and somehow passed through the German Federal Court of Justice four times while doing that, and it *still* is ongoing. All of that could’ve been prevented by just asking for permission.
...
→»»» [**Free Music, sound effects, photos and videos for your videos**](https://docs.google.com/spreadsheets/d/1dEbxtBlvwxj2ZwtcoNU05Cg4_pgpuBYAWbO_5twoA2A/edit#gid=0) «««←
...
You can [add to the spreadsheet](http://goo.gl/forms/jQ1sR1eOml) if you want to.

*The spreadsheet is licensed CC0, and this guide is licensed* [*CC-by 4.0*](https://creativecommons.org/licenses/by/4.0/)*.*

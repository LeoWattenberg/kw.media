---
id: 1434
slug: "the-audio-guide-to-happiness-or-how-to-make-your-streams-and-videos-sound-good"
path: "/youtube-tips-en/the-audio-guide-to-happiness-or-how-to-make-your-streams-and-videos-sound-good/"
title: "The Audio Guide to Happiness, or: How to make your Streams & Videos sound good"
excerpt: "A practical audio guide for creators covering microphones, levels, noise, room sound and the basics of making streams easier to hear."
...
To get the TL;DR first: **Any mic between 50 and 300 USD** ***probably*** **is gonna work fine for you**. This even goes for professionals; the Shure SM58 has been the industry standard for vocal performances since the ’60s – and you can get that one for 100 bucks or so. This isn’t to say that you should all go for the SM58, as it is an XLR mic and thus requires quite a bit of extra hardware (though I won’t judge if you do go for it).

**XLR mics** as a whole are a bit of a minefield. While in theory, you can adapt an XLR mic to your average 3.5mm jack, in practice, you’ll probably need a preamp to use them, and in the case of a condenser XLR mic, you’ll need a preamp that can deliver phantom power.These things aren’t impossible to figure out and do offer a lot of flexibility once you add multiple devices to your chain, but if you are a sole gamer just looking for a good mic, they add a lot of unnecessary complexity when you can have all of that in one convenient package as a [USB mic](/en/audacity/).
...
<figure class="image-large"><img src="https://preview.redd.it/usj6eb3ndcj51.png?width=1233&amp;format=png&amp;auto=webp&amp;s=836625c741f63b0baf299113b07c1cc4bbd7f839" alt><figcaption>Various polar patterns; the mic is pointing towards the top of the page. Image credit: Galak76 &amp; Nicoguaro at Wikipedia, CC-by-sa 3.0; CC-by 4.0</figcaption></figure>
...
Now, I still haven’t answered which mic I actually recommend, and that’s because there isn’t a definitive answer that’s more concrete than “a cardioid ‘studio’ mic is probably the right tool for the job”.

For example, Blue’s USB mics tend to be somewhat flat but respond super strongly to the proximity effect, while Røde’s USB mics tend to focus the mids more, so what sounds amazing for one person may not sound good for your voice (or in more formal terms, different mics have different **frequency responses**).

<figure class="image-large"><img src="https://preview.redd.it/lb50egaigcj51.png?width=1421&amp;format=png&amp;auto=webp&amp;s=ab5a9877ba0c5a4bcab2a163dd460c49a0195ccd" alt><figcaption>Frequency response of the Røde NT-USB. Being a cardioid/pressure gradient mic, the low end falls off a bit. The bump in the mid-highs is there to add clarity – whether this sounds good on you I can’t tell though. Image credit: Røde</figcaption></figure>
...
1. an elbow’s length away from your mouth *at most* , while being
2. almost but not directly in front of your mouth and
3. as far away from any other noise as possible.
...
<figure class="image-large"><img src="https://preview.redd.it/7adaoczxccj51.png?width=852&amp;format=png&amp;auto=webp&amp;s=9a79d7bab3f05c2f4c8ac5e9085b5733e910c81f" alt><figcaption>OBS’ noise suppression goes from “full fish tank” (-60dB) to “no noise reduction at all” (0dB)</figcaption></figure>

If you have some heavy noise going on around you, you can instead also try using [RTX Voice](https://www.nvidia.com/en-us/geforce/guides/nvidia-rtx-voice-setup-guide/) (which also works on GTX cards with some tinkering) or [krisp](https://help.krisp.ai/hc/en-us/articles/360012080560-How-to-Set-up-OBS-Studio-with-Krisp-Desktop-App) (which is a paid service). Both of them have in common that they do AI “magic”, which may catch more noise than the standard OBS denoiser does. Alternatively, you can use the [ReaPlugs VSTs](https://www.reaper.fm/reaplugs/), specifically ReaFIR – in “subtract” mode, it can create a noise profile and denoise based on that specific profile, which also generally introduces fewer artifacts than OBS’ denoiser. ReaPlugs works on pretty much any hardware, all the way to Windows 98 and Linux (via WINE) machines.
...
<figure class="image-large"><img src="https://preview.redd.it/gelsxwqkccj51.png?width=846&amp;format=png&amp;auto=webp&amp;s=4f04c94dc1944e9d71b7c0bae8d56aa2ae21650e" alt><figcaption>Example of the OBS compressor</figcaption></figure>

If you want equalize your audio afterwards, you can use an **equalizer**. This is somewhat optional as your choice of mic will already have some effect on how you sound, but if you dislike the sound of your mic or dislike the proximity effect, the equalizer can help. OBS doesn’t ship with one, but [ReaPlugs](https://www.reaper.fm/reaplugs/) does, ReaEQ and ReaFIR.
...
<figure class="image-large"><img src="https://preview.redd.it/923xvlraicj51.png?width=849&amp;format=png&amp;auto=webp&amp;s=947005bc27e29f3b712e5754db37c607a4bc5503" alt><figcaption>Example of the OBS limiter</figcaption></figure>
...
[kliksphilip recommends](https://www.youtube.com/watch?v=Ncec863W9XA) making your background music 20 dB quieter than your normal talking voice. I’d overall agree with that, though I will add that if your background music has a lot of dynamics in it (that is, quiet parts and loud parts), you can mercilessly compress them as well, just you can do with your voice. That way, at least the background music will be more consistent in itself.
...
- YouTube had a [workshop on good audio](https://www.youtube.com/watch?v=e83fPrDsnUA) recently.
- [Sound comparison](https://www.youtube.com/watch?v=_mLyLh7cN2s) between the Elgato Wave 3, Blue Snowball, Audio Technica ATR2100USB, Røde USB Mini, Blue Yeti Nano, Samson C01u Pro, Blue Yeti, HyperX Quadcast, Razer Seiren X, Beyerdynamic Fox, Audio Technica AT2020, Blue Ember, Shure SM7b and Neumann U67 — aka most of the mics which currently are currently targeting gamers/streamers/podcasters, plus some very expensive pro stuff.
- The [Wikipedia page on Microphones](https://en.wikipedia.org/wiki/Microphone) has quite a lot more technical stuff; good starting point if you are interested in the tech behind it.
- We have a [discord server](https://discord.gg/youtubegaming) if you want to chat with us, whether it is audio, games or something else!
